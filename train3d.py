...
def createNetwork():
    ...
    #print('aaa',h_fc1,'bbb',readout,'ccc',s)
    return s, readout, h_fc1 #readout has ACTIONS parameters
...
def trainNetwork(s, readout, h_fc1, sess):
    ...
    while True:
        ...
        action_index = 0
        if random.random() <= epsilon or time_step <= OBSERVE:
